<template>
  <component :is="component" v-bind="$props" :class="[
    'gantt-node',
    {
  ...
  ]" :style="style" @drag-start="onDragStart" @resize-start="onResizeStart" @focus-start="startFocus"
    @hover-start="startHover" @hover-end="endHover" />
</template>
<script lang="ts">
