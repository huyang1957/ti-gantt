...
export default {
  ...
  methods: {
    ...
    onDragEnd() {
       ...
       */
      this.$emit('dragged', { node: root, movedDays: movedCols, newData: newData })
    },
    ...
    onResizeEnd() {
       ...
       */
      this.$emit('resized', { node: root, resizedDays: resizedCols, newData: newData })
    },
  },
}
</script>
