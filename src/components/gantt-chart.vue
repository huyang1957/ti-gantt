      ...
      <section class="content" :style="contentStyle">
        <header>
          <section v-if="monthMode" class="months">
            <div v-for="m in months" :key="m" :class="[
              'month',
              {
          ...
          <section class="dates" v-if="dayMode || weekMode">
            <div v-for="d in dates" :key="d" :class="[
              'date',
              {
                rest: isRestDay(d),
                today: isToday(d),
              ...
              <div v-if="d in milestoneMap" class="milestone-line" @click="scrollToMilestone(milestoneMap[d].id)"></div>
            </div>
          </section>
          <div :class="[
            'hovering-node-date',
            { 'is-milestone': !hoveringNode.date.end },
          ]" v-if="hoveringNode.visible" :style="hoveringNodeStyle">
        ...
        <div ref="yScrollContainer" class="y-scroll-container" @scroll="onScroll">
          <gantt-layout :data="layoutData" :bus="bus" />
        </div>
      </section>
    </div>
    <section class="toolbar">
      <el-button v-if="hasToday" class="today" size="small" plain @click="scrollToToday">今天</el-button>
      <el-select v-model="colUnit" :clearable="false" size="small" class="col-unit">
