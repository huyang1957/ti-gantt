<template>
  <el-progress :class="['gantt-progress', type]" :stroke-width="strokeWidth" :percentage="progress" :show-text="false"
...
export default {
  ...
  props: {
    ...
    colors: {
      type: Array,
      default: () => [{ color: '#f56c6c', percentage: 20 }]
    },
    tip: {
      type: Object,
      default: () => {
